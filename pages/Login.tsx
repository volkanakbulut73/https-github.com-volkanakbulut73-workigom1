  ...
  const handleGoogleLogin = async () => {
    ...
    if (!isSupabaseConfigured()) {
        ...
        const mockUser: User = {
          ...
          avatar: 'https://lh3.googleusercontent.com/a/ACg8ocIq8d...=s96-c', // Generic google-like placeholder could go here
          rating: 5.0,
          location: 'İstanbul',
          goldenHearts: 5,
          silverHearts: 0,
          isAvailable: true,
          referralCode: 'GOOGLE1',
          wallet: {
            balance: 500.00,
            totalEarnings: 0,
            pendingBalance: 0
    ...
    try {
        ...
        // OAuth redirects, so no navigate() here usually
    } catch (err: any) {
        console.error(err);
      ...
      <div className="relative z-10 bg-white p-8 rounded-3xl shadow-2xl border border-gray-100 mt-10 max-w-md mx-auto w-full">
        ...
        <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-xs">
                <span className="px-2 bg-white text-gray-400 font-medium">veya</span>
            </div>
        </div>
        ...
        <button 
            ...
            className="w-full flex items-center justify-center gap-3 bg-white border border-gray-200 text-gray-700 font-bold py-3.5 rounded-xl hover:bg-gray-50 transition-all active:scale-[0.98]"
        >
            {isGoogleLoading ? (
