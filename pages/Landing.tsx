        ...
        <div className="flex-1 flex items-center relative z-10 py-12 md:py-0">
          <div className="max-w-7xl mx-auto px-6 w-full grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8 animate-fade-in text-center lg:text-left">
              <div className="inline-flex items-center gap-2 bg-white/5 backdrop-blur-lg px-4 py-1.5 rounded-full border border-white/10 shadow-xl mx-auto lg:mx-0 mt-12">
